...
//a.What does x receives from product, property or value?
// const product = {
...
// x nhận dc thông tin sản phẩm như tên sản phẩm, giá cả, màu sắc, nhãn hiệu, property(name, price, brand, color), value(Xiaomi rice cooker, 1700, Xiaomi, White)

//b.Use the for loop to print/log out the following output
...
//      expectedHours: 0.5,
// };
// let assignTo,dueDate,subject;
// ({assignTo,dueDate,subject} = task);
...
//3.Here is the actual data from...
 
//3.1 What is the data type of the outermost layer...

// Kiểu dữ liệu lớp ngoài cùng là Array

//3.2 The hits property...

// The hit property là nơi lưu trữ kết quả công việc nó là Array
...
//3.3 In each hit of hits...
 
// cách tìm chức danh, vị trí, mức lương, lợi ích, kỹ năng, yêu cầu công việc là dùng lệnh 
...
// while (true) {
//     alert('Hello,this is dev dictionary');
//     let key = prompt('Please search keyword');
//     if (key == 'debug') {
//         alert(`${key}\n${dictionary.debug}`);
...
//         alert(`${key}\n${dictionary.uiux}`);
//     } else {
//         alert(`Sorry, we do not find  ${key} dictionary`);
//         break;
//     }
// }
...
//         alert(`${key}\n${dictionary.uiux}`);
//     } else {
//         let exp = prompt(`Sorry, we do not find  "${key}" dictionary.\n You can define "${key}" in the box below`);
//         alert('');
//         dictionary[`${key}`]= exp;
//         console.log(dictionary);
//         key = prompt('Please enter the keyword just defined');
//             alert(`${key}\n${exp}`);           
//         break;
//     }
// }
...
//         console.log('Xiaomi portable charger 20000mah');
//         console.log(`Name: ${product[i].name}`);
//         console.log(`Price: ${product[i].price}`);
//     }
// }
...
// product[0].providers = ['phukienzero', 'dientucc'];
// product[1].providers = ['Tgdd', 'Ddghn', 'VnStore'];
// product[2].providers = ['tgdd'];
// product[3].providers = ['Tgdd'];
// for (i = 0; i < product.length; i++){
//     console.log(`#${i+1}. ${product[i].name}`);
//     console.log(`Price: ${product[i].price}`);
//     console.log(`Prodiders: ${product[i].providers}`);
// }

//5.e

// let supplier  = prompt('enter provider');
// console.log();
// for (i = 0; i < product[i].length; i++);{
//     for (j = 0; j < product[i].providers.length; j++);{
//         if (product[i].providers[j] == supplier);{
//             console.log('Xiaomi portable charger 20000mah');
//             console.log(`Name: ${product[i].name}`);
...
// }
// //6.b
// let sports = prompt('enter sports (new, delete, update, complete');
// if (sports == 'new') {
//     let newTask = prompt('enter quest');
...
// // let sports = prompt('enter sports (new, delete, update, complete');
// // if (sports == 'update') {
// //     let location = Number(prompt('location need update'));
// //     let newTask = prompt('enter new');
...
// // let sports = prompt('enter sports (new, delete, update, complete');
// // if (sports == 'complete') {
// //     let location = Number(prompt('location to be completed'));
...
// // let sports = prompt('enter sports (new, delete, update, complete');
// // if (sports == 'delete') {
// //     let location = Number(prompt('location need to delete'));
...
// // }
// // if (sports == 'complete') {
// //     let location = Number(prompt('location need ports'));
// //     prints[location-1].process = true;
// //     console.clear();
// //     for (i = 0; i < prints.length; i++) {
// //         if (i == location - 1) {
